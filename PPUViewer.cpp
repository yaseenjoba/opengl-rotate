...
PPUViewer::PPUViewer()
{
  ...
  m_RotateZButton = new QPushButton("RotateX");
  m_RotateZButton->setObjectName(QStringLiteral("RotateXButton"));
  mainLayout->addWidget(m_RotateZButton);
  connect(m_RotateZButton, SIGNAL(pressed()), m_RenderWidget, SLOT(rotateAboutX()));
}
